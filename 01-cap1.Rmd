...
>Além de representar os dados por meio de tabelas, você aprenderá no capítulo \@ref(c2) como representar os dados de forma gráfica. Este formato permite visualizar as informações de uma forma mais clara e mais explicativa.
...
Você irá aprender detalhadamente como aplicar estes métodos nos capítulos  \@ref(c9) e  \@ref(c10) deste *e-book*. 
