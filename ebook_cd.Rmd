...
Você irá aprender detalhadamente como aplicar estes métodos nos capítulos  \@ref(cap12) e  \@ref(cap13) deste *e-book*. 
...
Utilizando Python, explicada em nosso capítulo \@ref(cOPC) de programação, você conseguiria **ir além** e responder os seguintes questionamentos?
