...
def fazer_grafico_setores(eixo, tamanhos, afastamentos, cores_fatias, theta, titulo, cor_texto='black'):
    ...
    eixo.set_title(titulo, fontdict={'fontsize': TAMANHO_FONTE_TITLE}, pad=-50);
    eixo.axis('equal');
    return grafico
```
...
ax[0] = fazer_grafico_setores(ax[0], tamanhos, (0, 0.25), ('tab:blue', 'tab:red'), 12, '2015');

# 2019
legendas = e19_internet.index;
tamanhos = e19_internet.values;
ax[1] = fazer_grafico_setores(ax[1], tamanhos, (0, 0.25), ('tab:blue', 'tab:red'), 12, '2019');

# Legenda da figura
fig.legend(title='Acesso à Internet',loc='lower center', labels=legendas, fontsize=TAMANHO_FONTE_LABEL, title_fontsize=TAMANHO_FONTE_TITLE);
...
ax[0] = fazer_grafico_setores(ax[0], tamanhos, (0, 0, 0.25, 0.5, 0.75), ('tab:blue', 'tab:red', 'tab:green','tab:purple','tab:cyan'), 12, '2015');

# 2019
legendas = e19_pc.index;
tamanhos = e19_pc.values;
ax[1] = fazer_grafico_setores(ax[1], tamanhos, (0, 0, 0.25, 0.5, 0.75), ('tab:blue', 'tab:red', 'tab:green','tab:purple','tab:cyan'), 12, '2019');

# Legenda do plot
fig.legend(title='Acesso a computadores',loc='lower center', labels=legendas, fontsize=TAMANHO_FONTE_LABEL, title_fontsize=TAMANHO_FONTE_TITLE);
...
# Legenda do plot
fig.legend(title='Acesso a computadores',loc='lower center', labels=legendas, fontsize=TAMANHO_FONTE_TICKS, title_fontsize=TAMANHO_FONTE_LABEL);
...
plt.figure(figsize=(20,10));
eixo = sns.scatterplot(y='NU_NOTA_CN', x='NU_NOTA_MT',hue='TP_ESCOLA', data=dados_ssa_notas_2019, s=50);
...
plt.figure(figsize=(20,10));
eixo = sns.scatterplot(x='NU_NOTA_LC', y='NU_NOTA_MT',hue='TP_ESCOLA', data=dados_ssa_notas_2019, s=50);
